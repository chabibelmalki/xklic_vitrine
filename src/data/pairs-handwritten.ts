...
export const handwrittenPairs: Record<string, PairContent> = {
  ...
  "plomberie-argenteuil": {
    ...
    description:
      "Tu es plombier à Argenteuil ? Xklic te crée un site qui te place sur « plombier Argenteuil » et transforme les recherches urgentes en appels. En ligne en 48h, 49€ puis 9,99€/mois, sans engagement.",
    body: [
  ...
  "serrurerie-paris": {
    ...
    description:
      "Tu es serrurier à Paris ? Dans une ville saturée d'arnaques, un site pro clair te démarque et rassure avant l'appel. Xklic te place sur « serrurier Paris ». En ligne en 48h, 49€ puis 9,99€/mois.",
    body: [
      ...
      "Xklic te crée ce site de serrurier en 48 heures : design pro qui inspire confiance, tarifs indicatifs, zone d'intervention par arrondissement, appel et WhatsApp en un tap, le tout optimisé pour les recherches locales à Paris. 49 € à l'installation, puis 9,99 €/mois, sans engagement — tu arrêtes quand tu veux.",
    ],
    intents: [
      "serrurier paris",
  ...
  "electricite-argenteuil": {
    ...
    description:
      "Tu es électricien à Argenteuil ? Mises aux normes, dépannages, rénovations : Xklic te crée un site qui capte la demande locale et fait sonner ton téléphone. En ligne en 48h, 49€ puis 9,99€/mois.",
    body: [
      ...
      "Xklic te met en ligne en 48 heures : un site d'électricien pro, optimisé pour « électricien Argenteuil » et le 95, avec appel direct, WhatsApp, formulaire de devis et présentation claire de tes prestations. Les demandes arrivent chez toi, prêtes à rappeler. 49 € à l'installation, puis 9,99 €/mois, sans engagement.",
    ],
    intents: [
  ...
  "menage-paris": {
    ...
    description:
      "Aide-ménagère ou société de ménage à Paris ? Xklic te crée un site qui met en avant le crédit d'impôt de 50% et te fait trouver près de tes clients. En ligne en 48h, 49€ puis 9,99€/mois.",
    body: [
      ...
      "Xklic te crée ce site de ménage à domicile en 48 heures : présentation claire, mise en avant du crédit d'impôt, prise de contact par appel, WhatsApp et formulaire, optimisation pour les recherches locales à Paris. 49 € à l'installation, puis 9,99 €/mois, sans engagement.",
    ],
    intents: [
  ...
  "plomberie-cergy": {
    ...
    description:
      "Tu es plombier à Cergy ? Entre résidences neuves, grands ensembles et turnover étudiant, la demande est forte. Xklic te crée un site qui la capte. En ligne en 48h, 49€ puis 9,99€/mois.",
    body: [
      ...
      "Xklic te crée un site de plombier pensé pour Cergy et la ville nouvelle, en ligne en 48 heures : appel direct, WhatsApp, formulaire et optimisation pour Google local. Les demandes arrivent chez toi. 49 € à l'installation, puis 9,99 €/mois, sans engagement.",
    ],
    intents: [
      "plombier cergy",
  ...
  "mecanique-auto-argenteuil": {
    ...
    description:
      "Tu tiens un garage à Argenteuil ? Entretien, réparation, contre-visite : Xklic te crée un site qui te fait trouver et réserver — comme le Garage Méca Atlas. En ligne en 48h, 49€ puis 9,99€/mois.",
    body: [
      ...
      "Xklic te crée le site de ton garage en 48 heures : présentation de tes services, avis clients, horaires, appel et WhatsApp en un tap, optimisé pour « garage Argenteuil » et le 95. Les demandes arrivent directement chez toi. 49 € à l'installation, puis 9,99 €/mois, sans engagement.",
    ],
    intents: [
      "garage argenteuil",
